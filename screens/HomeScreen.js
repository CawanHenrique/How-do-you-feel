  ...
  return (
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText}>{loading ? 'Carregando...' : 'Diário da Nana'}</Text>
        <TouchableOpacity onPress={ () => navigation.navigate('Messages')}>
        <Image style={styles.userFoto} source={userIcon}/>
        </TouchableOpacity>
      </View>
      {loading ? (
      <ActivityIndicator size="large" color="#EA9088" />
      ): (
        <><FlatList
          data={data}
          renderItem={renderItem}
          keyExtractor={(item) => item.id}
          style={styles.list} /><StatusBar style="auto" /></>
      )}
      ...
      >
        <View style={styles.modalView}>
          ...
          <View style={styles.btnContainer}>
            ...
            >
              <Text style={styles.btnInteract}>Adicionar</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => setModalVisible(!modalVisible)}>
              <Text style={styles.btnInteract}>Fechar</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
